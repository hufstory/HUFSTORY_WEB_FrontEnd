  ...
  return (
    <div>
      ...
      <div className="ml-36 mr-36 mt-8 md:px-5 md:py-5 md:flex-row items-center">
        ...
        <div className="flex mt-20 text-black body-font bg-transparent relative p-10 rounded-[14px] shadow-default hover:-translate-y-1 hover:scale-100 duration-300">
