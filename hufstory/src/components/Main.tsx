...
const Main = () => {
  return (
    <div>
      {/*
      <div className="HufstoryLogo">
        <img
          className="contatiner mx-auto"
          src={hufstoryLogo}
          alt="MainHufstory"
        ></img>
      </div>
  */}
      ...
      <div className="container mx-auto flex md:px-5 md:py-24 pt-32 pb-10 md:flex-row flex-col-reverse items-center ">
        <div className="text-gray-700 body-font bg-transparent relative p-10 rounded-md shadow-xl hover:-translate-y-1 hover:scale-110 hover:shadow-2xl duration-300">
          <h1 className="font-bold text-4xl mb-5">
            한국외국어대학교 학생 IT 자치기구 훕스토리
          </h1>
